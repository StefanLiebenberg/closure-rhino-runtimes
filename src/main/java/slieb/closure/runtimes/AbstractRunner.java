...
public abstract class AbstractRunner implements RunnerInterface {
    ...
    public Scriptable getScriptable(@Nonnull String object) {
        return (Scriptable) evaluateString(object);
    }
    ...
    public Object getScriptableProperty(@Nonnull Scriptable object,
        ...
        return object.get(attributeName, getScope());
    }
    ...
    public Function getFunction(@Nonnull String name) {
        return (Function) getScriptable(name);
    }
    ...
    public Object call(@Nonnull String command,
                       ...
                       Object... args) {
        Function method = getFunction(command);
        if (method != null) {
            return method.call(context, scope, thisObject, args);
        } else {
            throw new RuntimeException("Method not found for command" +
                    command);
        }
    }
}
